...
<span style="color: orange;">**【分治】【树状数组】LuoguP1908 逆序对**</span>

【题目大意】求解序列$A=\left \{  a_1,a_2,\cdots,a_n\right \}$的逆序对数量。

???success "<span style="color: orange;">**LuoguP1908 逆序对**</span>树状数组实现"
	```
	#include<bits/stdc++.h>
    using namespace std;
    const int N=5e5+5;
...
???success "<span style="color: orange;">**LuoguP1908 逆序对**</span>分治实现"
	```
	#include<bits/stdc++.h>
    using namespace std;
    const int N=5e5+5;
